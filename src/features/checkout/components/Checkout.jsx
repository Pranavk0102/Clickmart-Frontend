...
import { fetchCart } from '../../cart/slices/cartSlice';
import { fetchAddresses } from '../../profile/slices/addressSlice';
import { placeOrder } from '../../orders/slices/orderSlice';
import { validateCoupon, clearValidatedCoupon } from '../slices/couponSlice';
...
const Checkout = () => {
  ...
  const handleValidateCoupon = async () => {
    ...
    try {
      await dispatch(validateCoupon({ code: couponCode, orderTotal: subtotal, categoryIds })).unwrap();
          ...
          <div className="box">
            ...
            {addresses.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '20px', color: '#888' }}>
                ...
                <Link to="/profile?tab=addresses" className="btn-orange" style={{ marginTop: '10px', display: 'inline-block' }}>
                  Add Address
                </Link>
              </div>
            ) : (
