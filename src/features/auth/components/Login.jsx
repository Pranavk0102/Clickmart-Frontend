              ...
              <form onSubmit={handleLoginSubmit} noValidate>
                ...
                <div className="form-group">
                  ...
                  <div style={{ textAlign: 'right', marginTop: '8px' }}>
                    <Link to="/forgot-password" style={{ color: '#ff8c00', fontSize: '12px', textDecoration: 'none' }}>
                      Forgot Password?
                    </Link>
                  </div>
                </div>
                <button type="submit" className="btn-orange" style={{ width: '100%', padding: '12px', marginTop: '10px' }} disabled={loading}>
