...
import { fetchAllOrders, updateOrderStatus } from '../slices/adminSlice';
  ...
  return (
    <div className="admin-body">
      ...
      <div className="stat-cards" style={{ gridTemplateColumns: 'repeat(4,1fr)', marginBottom: '24px' }}>
        ...
        <div className="stat-card">
          <div className="stat-icon" style={{ background: 'rgba(23,162,184,0.15)', color: '#17a2b8' }}><i className="fas fa-check"></i></div>
          <div className="stat-info"><div className="stat-label">Confirmed</div><div className="stat-value" style={{ color: '#17a2b8' }}>{orders.filter(o => o.status === 'CONFIRMED').length}</div></div>
        </div>
        <div className="stat-card">
